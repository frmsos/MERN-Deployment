...
module.exports = {
    ...
    registerUser: async (req, res) =>{
        ...
        try{
            ...
            .json({successMessage:"User register ", user:newUser})
    ...
    loginUser: async (req, res)=>{
        ...
        try{
            ...
            if(!validPass){
                ...
                res.status(201).cookie('userToken', userToken, {httpOnly:true, expires:new Date(Date.now() + 1800000)}).json({successMessage:"User login OK "})
            }
        }catch(error){
            res.status(400).json({error: "Incorrect credentials, try again..."})
        }
